...
$i++;
$modversion['blocks'][$i]['file'] = "sam_block_navigation.php";
$modversion['blocks'][$i]['name'] = 'Navigation Menu' ;
$modversion['blocks'][$i]['description'] = "Shows Navigation Menu for SAM";
$modversion['blocks'][$i]['show_func'] = "b_sam_block_navigation_show";
$modversion['blocks'][$i]['edit_func'] = "b_sam_block_navigation_edit";
$modversion['blocks'][$i]['options'] = "1|1|1|1";
$modversion['blocks'][$i]['template'] = "sam_block_navigation.html" ;

$i++;
$modversion['blocks'][$i]['file'] = "sam_block_currentsong.php";
$modversion['blocks'][$i]['name'] = 'Current Song ' ;
$modversion['blocks'][$i]['description'] = "Shows Current Song Block for SAM";
$modversion['blocks'][$i]['show_func'] = "b_sam_block_currentsong_show";
$modversion['blocks'][$i]['edit_func'] = "b_sam_block_currentsong_edit";
$modversion['blocks'][$i]['options'] = "";
$modversion['blocks'][$i]['template'] = "sam_block_currentsong.html";

$i++;
$modversion['blocks'][$i]['file'] = "sam_block_toprequests.php";
$modversion['blocks'][$i]['name'] = 'Top Requests' ;
$modversion['blocks'][$i]['description'] = "Shows Top Request Block for SAM";
$modversion['blocks'][$i]['show_func'] = "b_sam_block_toprequests_show";
$modversion['blocks'][$i]['edit_func'] = "b_sam_block_toprequests_edit";
$modversion['blocks'][$i]['options'] = "";
$modversion['blocks'][$i]['template'] = "sam_block_toprequests.html";
